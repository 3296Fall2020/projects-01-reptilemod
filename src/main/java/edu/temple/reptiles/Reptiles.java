...
//        ModTileEntityTypes.TILE_ENTITY_TYPES.register(FMLJavaModLoadingContext.get().getModEventBus());
    ...
    private void setup(final FMLCommonSetupEvent event)
    {
        ...
        DeferredWorkQueue.runLater(() -> {
            ...
            GlobalEntityTypeAttributes.put(ModEntityTypes.SNAKE.get(), NessieEntity.setCustomAttributes().create());
        });
    }
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        InterModComms.sendTo("reptiles", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
